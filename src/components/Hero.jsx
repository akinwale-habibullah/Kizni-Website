...
export default function Hero() {
  return (
    <div className="relative overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        <div className="text-center">
          <h1 className="text-4xl md:text-5xl lg:text-8xl font-normal text-gray-900 mb-6">
            {/* Your key to */}
            Your solution to
          </h1>
          <h1 className="text-4xl md:text-5xl lg:text-8xl font-bold text-gray-900 mb-6">
            ...
            {/* disconnected and frustrated workforce. */}
            {/* increasing operational costs. */}


            {/* informed decisions */}
            {/* Your key to real time insights */}
          ...
          <p className="text-xl md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            We're experts in Open Source ERP, CRM solutions, and business applications. Are you an SME, a manufacturer, an educational
            institution or a clinic? We can help you turn your operational challenges into growth drivers. Say goodbye
            to inefficiencies and hello to better performance.
          </p>
